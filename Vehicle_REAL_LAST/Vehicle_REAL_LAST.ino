...
if(r[0]==BLACK)
{
  setDifferentialDrive(0,-10);//只剩最右边压线了，要最大量的往右边转
  delay(150);
}
else if(r[7]==BLACK){
  setDifferentialDrive(0,10);//只剩最左边压线了，要最大量的往左边转
  delay(150);
}
else if(r[1]==BLACK){
   setDifferentialDrive(16,-14);
   delay(50);
}
else if(r[6]==BLACK){
   setDifferentialDrive(16,14);
   ...
   setDifferentialDrive(16,-6);
}
else if(r[5]==BLACK){
   setDifferentialDrive(16,6);
}
else setDifferentialDrive(16,0);


//if (num<=2&&num>0){
//    if (r[0] == BLACK && r[1] != BLACK && r[2] != BLACK && r[3] != BLACK && r[4] != BLACK && r[5] != BLACK && r[6] != BLACK && r[7] != BLACK)
//    {
//        setDifferentialDrive(0,-8);//01111只剩最右边压线了，要最大量的往右边转
//        delay(140);
//    }
//    else if (r[0] != BLACK && (r[1] == BLACK || r[2] == BLACK )&& r[3] != BLACK && r[4] != BLACK && r[5] != BLACK && r[6] != BLACK && r[7] != BLACK)
//    {
////        int turn = r[1]*(-6)+r[2]
//        setDifferentialDrive(16,-6);//右边转  maybe12
//    }
//    else if (r[0] != BLACK && r[1]!= BLACK && r[2] != BLACK && (r[3] == BLACK || r[4] == BLACK) && r[5] != BLACK && r[6] != BLACK && r[7] != BLACK)
//    {
//        setDifferentialDrive(18,0);//直行
//    }
//    else if (r[0] != BLACK && r[1] != BLACK && r[2] != BLACK && r[3] != BLACK && r[4] != BLACK && r[5] != BLACK && r[6] != BLACK && r[7] == BLACK)
//    {
//        setDifferentialDrive(0,8);//01111只剩最左边压线了，要最大量的往左边转
//        delay(140);
//    }
//    else if (r[0] != BLACK && r[1] != BLACK && r[2] != BLACK && r[3] != BLACK && r[4] != BLACK && (r[5] == BLACK || r[6] == BLACK) && r[7] != BLACK)
//    {
...
//else if (num>=3&&num<=4)
//{
//    if (r[0] == BLACK  && r[4] != BLACK && r[5] != BLACK && r[6] != BLACK && r[7] != BLACK)
//    {
//        setDifferentialDrive(0,-8);//右边大转
//        delay(140);
//    }
//    else if (r[0] != BLACK && r[1] != BLACK && r[2] != BLACK && r[3] != BLACK && (r[7] == BLACK))
//    {
//        setDifferentialDrive(0,8);//
//        delay(140);
//    }
//        else if (r[0] != BLACK && (r[1] == BLACK || r[2] == BLACK )&& r[3] != BLACK && r[4] != BLACK && r[5] != BLACK && r[6] != BLACK && r[7] != BLACK)
//    {
//        setDifferentialDrive(16,-10);//右边转  maybe12
//    }
//        else if (r[0] != BLACK && r[1] != BLACK && r[2] != BLACK && r[3] != BLACK && r[4] != BLACK && (r[5] == BLACK || r[6] == BLACK) && r[7] != BLACK)
//    {
//        setDifferentialDrive(16,10);//
//    }
//    else//到这里说明黑色部分以一种比较诡异的方式在分布，反正不是正常循迹，慢速前行
//    {
//        setDifferentialDrive(12,0);//直行
